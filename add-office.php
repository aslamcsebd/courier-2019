				...
				<table align="center">
		         <tbody>
		         	<tr>
			            <td colspan="3" class="TrackMediumBlue" align="right">
			            	<div class="gentxt" align="right">
			                	<div class="headtext13" align="center" style="background-color: #dfe6e9">
			                		<strong><h4>New Office Information</h4></strong>
			                	</div>
			            	</div>
			         	</td>
			         </tr>
			         ...
			         <tr>
			            <td align="right">&nbsp;</td>
			            <td>&nbsp;</td>
			            <td><input class="btn btn-success btn-fill pull-center" name="Submit" type="submit" onClick="MM_validateForm('OfficeName','','R','City','','R','PhoneNo','','R','OfficeTiming','','R','ContactPerson','','R','OfficeAddress','','R');return document.MM_returnValue" value="Add New Office "></td>
			         </tr>
		        	</tbody>
		     </table>
			</form>			
