      ...
      <nav class="navbar navbar-default navbar-fixed">
         <div class="collapse navbar-collapse" style="background-color: #ecf0f1;">
            <ul class="nav navbar-nav navbar-left" >
	               <a href="add-courier.php" class=" navbar-brand REDLink"><strong>Add Shipment</strong></a>
            </ul>
			   	...
			   	<tbody>
    					<tr>
      					<td colspan="3" class="TrackMediumBlue" align="right"><div class="gentxt" align="right">
          					<div style="background-color: #dfe6e9;" class="headtext13" align="center"><h5><strong>Shipper info : </strong></h5></div>
      						</div>
      					</td>      					
    					</tr>
    					<tr>
			         ...
			         <tr>
		            	<td colspan="3" class="TrackMediumBlue" align="right"><div class="headtext13" align="center" style="background-color: #dfe6e9;"><h5><strong>Receiver  info : </strong></h5></div>
		            	</td>
						</tr>
			         <tr>
			         ...
			         <tr>
			            <td colspan="3" class="TrackMediumBlue" align="center"><div class="headtext13" align="center" style="adding-bottom: 8px; background-color: #dfe6e9;"><h5><strong>Shipment   info : </strong></h5></div></td>
			         </tr>
			         <tr>
			         ...
			         <tr>
			            <td align="right">&nbsp;</td>
			            <td>&nbsp;</td>
			            <td><input class="btn btn-success btn-fill pull-center" name="Submit" type="submit" onClick="MM_validateForm('Shippername','','R','Shipperphone','','R','Receivername','','R','Receiverphone','','R','ConsignmentNo','','R','Weight','','R','Invoiceno','','R','Qnty','','RisNum','Totalfreight','','R','Pickuptime','','R','Shipperaddress','','R','Comments','','R','Weight','','RisNum','Totalfreight','','R');return document.MM_returnValue" value="Add Courier"></td>
			         </tr>
			      </tbody>
			   </table>
			</form>
